...
public class AsignaturasActivity extends AppCompatActivity {
    public static Asignatura asignaturaSelected = new Asignatura();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter = new ArrayAdapter<>(AsignaturasActivity.this, android.R.layout.simple_list_item_1, listado);
        ...
        lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                asignaturaSelected = (Asignatura) lista.getItemAtPosition(position);
                Intent intent = new Intent(AsignaturasActivity.this, VerAsignaturaActivity.class);
